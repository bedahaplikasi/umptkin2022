...
public class C3463e {
    ...
    /* renamed from: a */
    private Set<String> f10954a;

    public C3463e(List<String> list) {
        this.f10954a = new HashSet(list);
    }

    /* renamed from: a */
    public static C3463e m15305a(Intent intent) {
        ...
        return new C3463e(arrayList);
    }

    /* renamed from: b */
    public String[] mo9628b() {
        return (String[]) this.f10954a.toArray(new String[this.f10954a.size()]);
    }
}
