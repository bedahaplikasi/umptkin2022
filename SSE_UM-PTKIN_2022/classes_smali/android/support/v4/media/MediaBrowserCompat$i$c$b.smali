...
.field final synthetic d:Landroid/support/v4/media/MediaBrowserCompat$i$c;
...
.method constructor <init>(Landroid/support/v4/media/MediaBrowserCompat$i$c;Landroid/content/ComponentName;)V
    ...
    iput-object p1, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$b;->d:Landroid/support/v4/media/MediaBrowserCompat$i$c;

    iput-object p2, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$b;->c:Landroid/content/ComponentName;
...
.method public run()V
    ...
    iget-object v1, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$b;->c:Landroid/content/ComponentName;
    ...
    iget-object v1, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$b;->d:Landroid/support/v4/media/MediaBrowserCompat$i$c;

    iget-object v1, v1, Landroid/support/v4/media/MediaBrowserCompat$i$c;->c:Landroid/support/v4/media/MediaBrowserCompat$i;
    ...
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$b;->d:Landroid/support/v4/media/MediaBrowserCompat$i$c;
