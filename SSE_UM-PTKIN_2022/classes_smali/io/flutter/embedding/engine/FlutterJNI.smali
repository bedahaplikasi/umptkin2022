...
.field private localizationPlugin:Lf/b/c/b/a;

.field private final mainLooper:Landroid/os/Looper;

.field private nativeShellHolderId:Ljava/lang/Long;

.field private platformMessageHandler:Lio/flutter/embedding/engine/f/c;
...
.method public static decodeImage(Ljava/nio/ByteBuffer;J)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, p2, p0}, Lf/b/b;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private handlePlatformMessageResponse(ILjava/nio/ByteBuffer;)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Lio/flutter/embedding/engine/f/c;

    if-eqz v0, :cond_7

    invoke-interface {v0, p1, p2}, Lio/flutter/embedding/engine/f/c;->d(ILjava/nio/ByteBuffer;)V
...
.method computePlatformResolvedLocale([Ljava/lang/String;)[Ljava/lang/String;
    ...
    iget-object v1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lf/b/c/b/a;
    ...
    :cond_56
    iget-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lf/b/c/b/a;

    invoke-virtual {p1, v1}, Lf/b/c/b/a;->c(Ljava/util/List;)Ljava/util/Locale;
...
.method public createOverlaySurface()Lio/flutter/embedding/engine/FlutterOverlaySurface;
    ...
    invoke-virtual {v0}, Lio/flutter/plugin/platform/l;->z()Lio/flutter/embedding/engine/FlutterOverlaySurface;
...
.method public dispatchSemanticsAction(ILio/flutter/view/c$g;Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, p3}, Lf/b/c/a/q;->a(Ljava/lang/Object;)Ljava/nio/ByteBuffer;
    ...
    :goto_12
    iget p2, p2, Lio/flutter/view/c$g;->c:I
...
.method public handlePlatformMessage(Ljava/lang/String;Ljava/nio/ByteBuffer;I)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lio/flutter/embedding/engine/f/c;->e(Ljava/lang/String;Ljava/nio/ByteBuffer;I)V
...
.method public onDisplayOverlaySurface(IIIII)V
    ...
    invoke-virtual/range {v0 .. v5}, Lio/flutter/plugin/platform/l;->T(IIIII)V
...
.method public onDisplayPlatformView(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
    ...
    invoke-virtual/range {v1 .. v9}, Lio/flutter/plugin/platform/l;->U(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
...
.method public onFirstFrame()V
    ...
    invoke-interface {v1}, Lio/flutter/embedding/engine/renderer/b;->g()V
...
.method onRenderingStopped()V
    ...
    invoke-interface {v1}, Lio/flutter/embedding/engine/renderer/b;->d()V
...
.method public requestDartDeferredLibrary(I)V
    ...
    invoke-interface {v0, p1, v1}, Lio/flutter/embedding/engine/g/a;->e(ILjava/lang/String;)V
    ...
    invoke-static {p1, v0}, Lf/b/b;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public setDeferredComponentManager(Lio/flutter/embedding/engine/g/a;)V
    ...
    invoke-interface {p1, p0}, Lio/flutter/embedding/engine/g/a;->c(Lio/flutter/embedding/engine/FlutterJNI;)V

    :cond_a
    return-void
.end method

.method public setLocalizationPlugin(Lf/b/c/b/a;)V
    .registers 2

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lf/b/c/b/a;

    return-void
.end method

.method public setPlatformMessageHandler(Lio/flutter/embedding/engine/f/c;)V
    .registers 2

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Lio/flutter/embedding/engine/f/c;
...
.method public spawn(Ljava/lang/String;Ljava/lang/String;)Lio/flutter/embedding/engine/FlutterJNI;
    ...
    invoke-static {p2, v0}, Lf/b/d/b;->a(ZLjava/lang/Object;)V
