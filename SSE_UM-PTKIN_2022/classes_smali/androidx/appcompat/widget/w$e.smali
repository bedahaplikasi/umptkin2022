...
.method public constructor <init>(Landroidx/appcompat/widget/w;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/j0;->z(Landroid/view/View;)V

    const/4 p2, 0x1

    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/j0;->F(Z)V
    ...
    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/j0;->H(Landroid/widget/AdapterView$OnItemClickListener;)V
...
.method O()V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/j0;->f()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, v1, Landroidx/appcompat/widget/w;->j:Landroid/graphics/Rect;
    ...
    iget-object v0, v0, Landroidx/appcompat/widget/w;->j:Landroid/graphics/Rect;
    ...
    iget v5, v4, Landroidx/appcompat/widget/w;->i:I
    ...
    iget-object v6, v6, Landroidx/appcompat/widget/w;->j:Landroid/graphics/Rect;
    ...
    :goto_7e
    invoke-virtual {p0, v4}, Landroidx/appcompat/widget/j0;->B(I)V

    goto :goto_85

    :cond_82
    invoke-virtual {p0, v5}, Landroidx/appcompat/widget/j0;->B(I)V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/j0;->v()I
...
.method Q(Landroid/view/View;)Z
    ...
    invoke-static {p1}, Lb/d/p/r;->t(Landroid/view/View;)Z
...
.method public m(II)V
    ...
    invoke-virtual {p0, v1}, Landroidx/appcompat/widget/j0;->E(I)V

    invoke-super {p0}, Landroidx/appcompat/widget/j0;->a()V

    invoke-virtual {p0}, Landroidx/appcompat/widget/j0;->g()Landroid/widget/ListView;
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/j0;->G(Landroid/widget/PopupWindow$OnDismissListener;)V
