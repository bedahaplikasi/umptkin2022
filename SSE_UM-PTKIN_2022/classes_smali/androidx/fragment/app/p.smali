...
.method protected static d(Ljava/util/List;Landroid/view/View;)V
    ...
    invoke-static {p0, p1, v0}, Landroidx/fragment/app/p;->h(Ljava/util/List;Landroid/view/View;I)Z
    ...
    invoke-static {p0, v4, v0}, Landroidx/fragment/app/p;->h(Ljava/util/List;Landroid/view/View;I)Z
...
.method f(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    invoke-static {p2}, Lb/d/p/t;->a(Landroid/view/ViewGroup;)Z
    ...
    invoke-virtual {p0, p1, v2}, Landroidx/fragment/app/p;->f(Ljava/util/ArrayList;Landroid/view/View;)V
...
.method j(Ljava/util/Map;Landroid/view/View;)V
    ...
    invoke-static {p2}, Lb/d/p/r;->p(Landroid/view/View;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, v2}, Landroidx/fragment/app/p;->j(Ljava/util/Map;Landroid/view/View;)V
...
.method o(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, Lb/d/p/r;->p(Landroid/view/View;)Ljava/lang/String;
    ...
    invoke-static {v3, v4}, Lb/d/p/r;->M(Landroid/view/View;Ljava/lang/String;)V
...
.method s(Landroid/view/ViewGroup;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    invoke-direct {v0, p0, p2, p3}, Landroidx/fragment/app/p$c;-><init>(Landroidx/fragment/app/p;Ljava/util/ArrayList;Ljava/util/Map;)V

    invoke-static {p1, v0}, Lb/d/p/p;->a(Landroid/view/View;Ljava/lang/Runnable;)Lb/d/p/p;
...
.method w(Landroid/view/View;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    invoke-direct {v0, p0, p2, p3}, Landroidx/fragment/app/p$b;-><init>(Landroidx/fragment/app/p;Ljava/util/ArrayList;Ljava/util/Map;)V
...
.method x(Landroid/view/View;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    invoke-static {v3, v5}, Lb/d/p/r;->M(Landroid/view/View;Ljava/lang/String;)V
    ...
    :cond_44
    new-instance p5, Landroidx/fragment/app/p$a;
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/fragment/app/p$a;-><init>(Landroidx/fragment/app/p;ILjava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;)V

    invoke-static {p1, p5}, Lb/d/p/p;->a(Landroid/view/View;Ljava/lang/Runnable;)Lb/d/p/p;
